...
class AppColors {
  ...
  static const tealDark = Color(0xFF0B5B54);
  static const tealPale = Color(0xFFE6F5F3);
  ...
  static const dangerBg = Color(0xFFFDE1E1);
  static const border = Color(0xFFE5E7EB);

  static const red = danger;
  static const redBg = dangerBg;
  static const amber = warning;
  static const amberBg = warningBg;
  static const green = success;
  static const greenBg = successBg;
  static const surface = Colors.white;
  static const amberLight = Color(0xFFFFF8E1);
  static const blue = Color(0xFF2563EB);
  static const blueBg = Color(0xFFDBEAFE);
  static const redLight = Color(0xFFFFEBEE);
  static const textMuted = textFaint;
  static const background = bg;
  static const greenLight = Color(0xFFE8F5E9);
  static const divider = Color(0xFFE5E7EB);
  static const tealLight = tealPale;
  static const infoBg = tealPale;
  static const teal700 = Color(0xFF00796B);
  static const ink = textSecondary;
  static const muted = textFaint;
